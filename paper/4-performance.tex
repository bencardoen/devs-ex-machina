...
\begin{figure}
    ...
    \includegraphics[width=0.65\columnwidth]{fig/interconnect_model.pdf}
    \caption{HighInterconnect model for three models.}
    \label{fig:interconnect_model}

    \vspace{0.5cm}

    \includegraphics[width=0.65\columnwidth]{fig/phold_model.pdf}
...
\begin{figure}
    \center
	\includegraphics[width=0.8\columnwidth]{fig/queue_sequential.eps}
...
\begin{figure}
    \center
	\includegraphics[width=0.8\columnwidth]{fig/interconnect_sequential.eps}
...
%TODO: Why is this the ideal case?
...
\begin{figure}
    \center
	\includegraphics[width=0.8\columnwidth]{fig/queue_parallel.eps}
...
\begin{figure}
    \center
    \includegraphics[width=0.8\columnwidth]{fig/phold_remotes.eps}
    \caption{Phold benchmark results for parallel simulation using six cores, with varying fraction of remote events.}
\end{figure}
...
\begin{figure}
    \center
    \includegraphics[width=0.8\columnwidth]{fig/phold_priority.eps}
...
When the number of nodes increases, performance decreases due to increasing contention in conservative simulation and an increasing amount of roll bakcs in optimistic.
...
\begin{figure}
    \center
    \includegraphics[width=0.8\columnwidth]{fig/interconnect_parallel.eps}
