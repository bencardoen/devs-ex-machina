...
\begin{figure}
	...
	\caption{Queue benchmark results}
...
As can be seen in Figure~\ref{fig:HighInterconnect_benchmark}, adevs now outperforms dxex by a fair margin.
...
\begin{figure}
	...
	\caption{Queue parallel simulation results using 4 nodes.}
\end{figure}
