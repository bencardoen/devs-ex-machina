...
Through profiling, we found that adevs spends much time routing the simulation messages (\textit{e.g.}, \textit{*}, \textit{@}) through the hierarchy, whereas dxex avoids this through its flattened model structure.
