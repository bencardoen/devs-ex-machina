...
#ifndef SIMPLEMSGSCHEDULER_H
#define SIMPLEMSGSCHEDULER_H
...
class SimpleMessageScheduler: public Scheduler<S> {
public:
...
protected:
	SimpleMessageScheduler() {
		;
	}

public:

	virtual ~SimpleMessageScheduler() {
		;
	}
...
#include "simplemsgscheduler.tpp"
#endif
