This section briefly introduces the synchronization protocols used by \textit{dxex}: conservative and optimistic synchronization.
...
The main advantage is that a small lookahead, caused by a very infrequent event, will not limit performance.
