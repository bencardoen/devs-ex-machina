...
Dxex is a C++11-based \textsf{Parallel DEVS} simulator, based on the design of PythonPDEVS.
...
Dxex supports, similarly to PythonPDEVS, the following features: direct connection~\cite{SymbolicFlattening}, \textsf{Dynamic Structure DEVS}~\cite{DSDEVS}, termination conditions~\cite{JDF}, and a modular tracing and scheduling framework~\cite{PythonPDEVS}.
...
Definig the lookahead is difficult and can often be unpredictable.
